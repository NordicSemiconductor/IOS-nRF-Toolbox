...
class CSCViewController: BaseViewController, CBCentralManagerDelegate, CBPeripheralDelegate, ScannerDelegate {
    ...
    @IBAction func aboutButtonTapped(_ sender: AnyObject) {
        self.showAbout(message: AppUtilities.getHelpTextForService(service: .csc))
    }

    //MARK: - UIViewController delegate
    required init?(coder aDecoder: NSCoder) {
        cscServiceUUID                   = CBUUID(string: ServiceIdentifiers.cscServiceUUIDString)
        cscMeasurementCharacteristicUUID = CBUUID(string: ServiceIdentifiers.cscMeasurementCharacteristicUUIDString)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let scannerViewController = navigationController.children.first as! ScannerViewController
    ...
    //MARK: -  CSCViewController implementation
