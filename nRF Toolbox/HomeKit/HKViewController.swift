...
class HKViewController: BaseViewController, HMHomeDelegate, HMHomeManagerDelegate, HKScannerDelegate, UITableViewDataSource, UITableViewDelegate, StoryboardInstance {
    ...
    private var homeStore: HKHomeStore!
    ...
    func handleAboutButtonTapped() {
        showAbout(message: AppUtilities.getHelpTextForService(service: .homekit))
    }
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        homeStore = HKHomeStore.sharedHomeStore
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == homeKitScannerSegue {
            ...
            let scannerView = navigationController?.topViewController as? HKScannerViewController
            scannerView?.delegate = self
        } else if segue.identifier == homeKitAccessorySegue {
            let accessoryView = segue.destination as? HKAccessoryViewController
